...
<div class="container">
    ...
    <form action="{{ route('peminjamans.update', $peminjaman->id_peminjaman) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="no_buku" name="no_buku" value="{{ $peminjaman->no_buku }}" required>
        </div>
        <div class="form-group">
            <label for="id_anggota">ID Anggota</label>
            <input type="number" class="form-control" id="id_anggota" name="id_anggota" value="{{ $peminjaman->id_anggota }}" required>
        </div>
        <div class="form-group">
